...
// var COLORS = {white: "rgb(235, 243, 255)", black: "rgb(147, 152, 158)", blue: "rgb(225, 224, 255)", red: "rgb(223, 228, 255)"};
var COLORS = {white: "rgb(235, 243, 255)", black: "rgb(147, 152, 158)", blue: "rgb(88, 81, 159)", red: "rgb(217, 16, 100)"};
    ...
    if(gameRunning){
        if (checkWinCondition(mainBoard) !== 0) {
            ...
            if(checkWinCondition(mainBoard) === 1){
                document.getElementById("result").innerHTML = playerNames[0] + " GANA!";
            }else{
                document.getElementById("result").innerHTML = playerNames[1] + " GANA!";
            }
        }
        ...
        if(countw === 0){
            gameRunning = false;
            document.getElementById("winMenu").removeAttribute("hidden");
            document.getElementById("result").innerHTML = "¡FUE UN EMPATE!";
        }
    }
